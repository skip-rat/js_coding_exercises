...
export function capitalize(word) {
  ...
  // if the first letter is a capital return the word
  if (/[A-Z\W]/.test(word.charAt(0))) return word;

  // Capitilise the first letter of word and join the rest of the letters
